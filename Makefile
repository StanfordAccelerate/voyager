...
test/compiler/proto/param.pb.cc: quantized-training/src/quantized_training/accelerator/param.proto
	protoc -I=quantized-training/src/quantized_training/accelerator --cpp_out=test/compiler/proto $<
