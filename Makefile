...
$(CC_BUILD_DIR)/Simulation.o: test/common/Simulation.cc test/common/Simulation.h src/ArchitectureParams.h $(wildcard src/datatypes/*.h) test/common/VerificationTypes.h
	$(CC) $(C17FLAGS) -c -o $@ $<
