...
std::vector<std::string> backwardOrder{
    "classifier",
...
const SimplifiedParams value_projection_backward = {
    ...
    .OUTPUT_OFFSET = 0,
    .WEIGHT_TRANSPOSE = true,
    .loops = {{2, 1, 4, 1, 1, 1}, {8, 8, 1, 1, 1, 64}},
    .inputXLoopIndex = {0, 5},
    .inputYLoopIndex = {1, 4},
    .reductionLoopIndex = {3, 0},
    .weightLoopIndex = {2, 1},
...
std::map<std::string, SimplifiedParams> backwardParams{
...
std::map<std::string, MemoryOffsets> backwardMemOffsets{
    {"classifier",
     {
         INTERMEDIATE_SIZE,
         0,
...
std::map<std::string, Files> backwardTestFiles{
    {"classifier",
     {
         "classifier",
         "mobilebert_labels",
