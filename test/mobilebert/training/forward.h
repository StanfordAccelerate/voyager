...
std::vector<std::string> forwardOrder{
...
std::map<std::string, SimplifiedParams> forwardParams{
...
std::map<std::string, MemoryOffsets> forwardMemOffsets{
    {"bottleneck_attention_dense",
     {
         0,
    ...
    {"attention_self_attention_scores_1",
     {
         INTERMEDIATE_SIZE + ATTENTION_HEAD_SIZE,
    ...
    {"attention_self_context_layer_1",
     {
         ...
         INTERMEDIATE_SIZE + 1 * ATTENTION_HEAD_SIZE,
     }},
    {"attention_self_attention_scores_2",
     {
         INTERMEDIATE_SIZE + 2 * ATTENTION_HEAD_SIZE,
         INTERMEDIATE_SIZE + 2 * INTRA_BOTTLENECK_SIZE +
    ...
    {"attention_self_attention_scores_3",
     {
         INTERMEDIATE_SIZE + 3 * ATTENTION_HEAD_SIZE,
         INTERMEDIATE_SIZE + 2 * INTRA_BOTTLENECK_SIZE +
...
std::map<std::string, Files> forwardTestFiles{
    // Input Bottleneck
    {"bottleneck_input_dense",
     {
         "hidden_states",
