...
std::map<std::string, MemoryOffsets> inferenceMemOffsets{
    ...
    {"attention_self_attention_scores_2",
     {
         INTERMEDIATE_SIZE + 5 * INTRA_BOTTLENECK_SIZE + 2 * ATTENTION_HEAD_SIZE,
         INTERMEDIATE_SIZE + 6 * INTRA_BOTTLENECK_SIZE + 2 * ATTENTION_HEAD_SIZE,
         INTERMEDIATE_SIZE + 9 * INTRA_BOTTLENECK_SIZE,
     }},
    {"attention_self_attention_scores_3",
     {
         INTERMEDIATE_SIZE + 5 * INTRA_BOTTLENECK_SIZE + 3 * ATTENTION_HEAD_SIZE,
         INTERMEDIATE_SIZE + 6 * INTRA_BOTTLENECK_SIZE + 3 * ATTENTION_HEAD_SIZE,
    ...
    {"attention_self_context_layer_1",
     {
         INTERMEDIATE_SIZE + 12 * INTRA_BOTTLENECK_SIZE,
         INTERMEDIATE_SIZE + 2 * INTRA_BOTTLENECK_SIZE + 1 * ATTENTION_HEAD_SIZE,
         INTERMEDIATE_SIZE + 15 * INTRA_BOTTLENECK_SIZE + 1 * ATTENTION_HEAD_SIZE,
     }},
    {"attention_self_context_layer_2",
     {
         INTERMEDIATE_SIZE + 13 * INTRA_BOTTLENECK_SIZE,
         INTERMEDIATE_SIZE + 2 * INTRA_BOTTLENECK_SIZE + 2 * ATTENTION_HEAD_SIZE,
         INTERMEDIATE_SIZE + 15 * INTRA_BOTTLENECK_SIZE + 2 * ATTENTION_HEAD_SIZE,
     }},
    {"attention_self_context_layer_3",
     {
         INTERMEDIATE_SIZE + 14 * INTRA_BOTTLENECK_SIZE,
         INTERMEDIATE_SIZE + 2 * INTRA_BOTTLENECK_SIZE + 3 * ATTENTION_HEAD_SIZE,
         INTERMEDIATE_SIZE + 15 * INTRA_BOTTLENECK_SIZE + 3 * ATTENTION_HEAD_SIZE,
     }},
    {"attention_output_dense",
     {
         INTERMEDIATE_SIZE + 15 * INTRA_BOTTLENECK_SIZE,
    ...
    {"ffn_2_output_dense",
     {
         ...
         9 * INTERMEDIATE_SIZE + 3 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 18 * INTRA_BOTTLENECK_BIAS_SIZE,
         3 * INTERMEDIATE_SIZE + 21 * INTRA_BOTTLENECK_SIZE,
     }},
    {"ffn_2_output_LayerNorm",
     {
         4 * INTERMEDIATE_SIZE + 22 * INTRA_BOTTLENECK_SIZE,
         9 * INTERMEDIATE_SIZE + 3 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 19 * INTRA_BOTTLENECK_BIAS_SIZE,
         4 * INTERMEDIATE_SIZE + 23 * INTRA_BOTTLENECK_SIZE,
         9 * INTERMEDIATE_SIZE + 3 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 20 * INTRA_BOTTLENECK_BIAS_SIZE,
     }},
    {"intermediate_dense",
     {
         4 * INTERMEDIATE_SIZE + 23 * INTRA_BOTTLENECK_SIZE,
         9 * INTERMEDIATE_SIZE + 3 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 21 * INTRA_BOTTLENECK_BIAS_SIZE,
         4 * INTERMEDIATE_SIZE + 24 * INTRA_BOTTLENECK_SIZE,
         10 * INTERMEDIATE_SIZE + 3 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 21 * INTRA_BOTTLENECK_BIAS_SIZE,
     }},
    {"output_dense",
     {
         4 * INTERMEDIATE_SIZE + 24 * INTRA_BOTTLENECK_SIZE,
         10 * INTERMEDIATE_SIZE + 4 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 21 * INTRA_BOTTLENECK_BIAS_SIZE,
         5 * INTERMEDIATE_SIZE + 24 * INTRA_BOTTLENECK_SIZE,
         11 * INTERMEDIATE_SIZE + 4 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 21 * INTRA_BOTTLENECK_BIAS_SIZE,
         4 * INTERMEDIATE_SIZE + 23 * INTRA_BOTTLENECK_SIZE,
     }},
    {"output_LayerNorm",
     {
         5 * INTERMEDIATE_SIZE + 24 * INTRA_BOTTLENECK_SIZE,
         11 * INTERMEDIATE_SIZE + 4 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 22 * INTRA_BOTTLENECK_BIAS_SIZE,
         5 * INTERMEDIATE_SIZE + 25 * INTRA_BOTTLENECK_SIZE,
         11 * INTERMEDIATE_SIZE + 4 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 23 * INTRA_BOTTLENECK_BIAS_SIZE,
     }},
    {"output_bottleneck_dense",
     {
         5 * INTERMEDIATE_SIZE + 25 * INTRA_BOTTLENECK_SIZE,
         11 * INTERMEDIATE_SIZE + 4 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 24 * INTRA_BOTTLENECK_BIAS_SIZE,
         5 * INTERMEDIATE_SIZE + 26 * INTRA_BOTTLENECK_SIZE,
         12 * INTERMEDIATE_SIZE + 4 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 24 * INTRA_BOTTLENECK_BIAS_SIZE,
         0,
     }},
    {"output_bottleneck_LayerNorm",
     {
         5 * INTERMEDIATE_SIZE + 26 * INTRA_BOTTLENECK_SIZE,
         12 * INTERMEDIATE_SIZE + 5 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 24 * INTRA_BOTTLENECK_BIAS_SIZE,
         6 * INTERMEDIATE_SIZE + 26 * INTRA_BOTTLENECK_SIZE,
         12 * INTERMEDIATE_SIZE + 6 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 24 * INTRA_BOTTLENECK_BIAS_SIZE,
     }},
    {"classifier",
     {
         6 * INTERMEDIATE_SIZE + 26 * INTRA_BOTTLENECK_SIZE,
         12 * INTERMEDIATE_SIZE + 7 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 24 * INTRA_BOTTLENECK_BIAS_SIZE,
         7 * INTERMEDIATE_SIZE + 26 * INTRA_BOTTLENECK_SIZE,
         12 * INTERMEDIATE_SIZE + 23 * INTERMEDIATE_BIAS_SIZE +
             3 * INTRA_BOTTLENECK_SIZE + 24 * INTRA_BOTTLENECK_BIAS_SIZE,
     }},
};
