    ...
    {"classifier",
     {
         ...
         12 * INTERMEDIATE_SIZE + 23 * INTERMEDIATE_BIAS_SIZE +
             ...
             24 * INTRA_BOTTLENECK_BIAS_SIZE,  // classfier bias gradient offset
         0,
     }},
    {"output_bottleneck_LayerNorm",
     {
    ...
    {"attention_self_key_layer_2",
     {
         ...
         INTERMEDIATE_SIZE + 7 * INTRA_BOTTLENECK_SIZE + 2 * ATTENTION_HEAD_SIZE,
     }},
    {"attention_self_key_layer_3",
     {
         INTERMEDIATE_SIZE + 5 * INTRA_BOTTLENECK_SIZE,
         INTERMEDIATE_SIZE + 5 * INTRA_BOTTLENECK_SIZE + 3 * ATTENTION_HEAD_SIZE,
         INTERMEDIATE_SIZE + 7 * INTRA_BOTTLENECK_SIZE + 3 * ATTENTION_HEAD_SIZE,
     }},
