...
extern "C" int sc_main(int argc, char* argv[]) {
  ...
  for (auto op : inferenceOperations) {
    ...
    params.INPUT_OFFSET = memOffsets.INPUT_OFFSET + 32768;
    params.WEIGHT_OFFSET = params.WEIGHT ? memOffsets.WEIGHT_OFFSET
                                         : memOffsets.WEIGHT_OFFSET + 32768;
    params.OUTPUT_OFFSET = memOffsets.OUTPUT_OFFSET + 32768;
    params.BIAS_OFFSET = memOffsets.BIAS_OFFSET;
    params.RESIDUAL_OFFSET = memOffsets.RESIDUAL_OFFSET + 32768;
