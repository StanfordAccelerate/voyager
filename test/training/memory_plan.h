...
#define CHECKPOINT_SIZE (128 * 512 * NUM_CHECKPOINTS)
...
#define LORA_W_PER_ENC_SIZE \
  (LORA_WQ_A_SIZE + LORA_WQ_B_SIZE + LORA_WV_A_SIZE + LORA_WV_B_SIZE)
...
#define MAX_GRAD (CLASSIFIER_G + CLASSIFIER_G_SIZE + CLASSIFIER_B_SIZE)
