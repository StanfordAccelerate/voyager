...
set full_block_name "VectorUnit<$IO_DATATYPE, $ACCUM_DATATYPE, $OC_DIMENSION>"
...
proc pre_assembly {} {
  ...
  global IO_DATATYPE ACCUM_DATATYPE OC_DIMENSION
  set maxpool_name "MaxpoolUnit<$ACCUM_DATATYPE,$IO_DATATYPE,$OC_DIMENSION>"
  set maxpool_name_stripped [string map {" " ""} $maxpool_name]
  set vector_fetch_name "VectorFetchUnit<$IO_DATATYPE,$ACCUM_DATATYPE,$OC_DIMENSION>"
  set vector_fetch_name_stripped [string map {" " ""} $vector_fetch_name]
  set output_address_name "OutputAddressGenerator<$OC_DIMENSION>"
  set output_address_name_stripped [string map {" " ""} $output_address_name]
  set vector_op_name "VectorOpUnit<$IO_DATATYPE,$ACCUM_DATATYPE,$OC_DIMENSION>"
