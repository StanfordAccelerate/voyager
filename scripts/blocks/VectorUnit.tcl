...
proc pre_assembly {} {
  ...
  set maxpool_name "MaxpoolUnit<$VECTOR_DATATYPE,$SCALE_DATATYPE,$IO_DATATYPE,$OC_DIMENSION>"
  ...
  set output_address_name "OutputAddressGenerator<$VECTOR_DATATYPE,$SCALE_DATATYPE,$IO_DATATYPE,$OC_DIMENSION>"
