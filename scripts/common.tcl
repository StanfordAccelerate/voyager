...
set project_folder "$root/build/${datatype}_${DIMENSION}x${DIMENSION}/Catapult/clock_${clk_period}/$block"
...
logfile move "$root/build/${datatype}_${DIMENSION}x${DIMENSION}/Catapult/clock_${clk_period}/$block.log"
...
options set Input/SearchPath "$root/lib"
...
options set Flows/VCS/COMP_FLAGS "-O3 -Wall -Wno-unknown-pragmas -I$root/lib/ -I$root/src/ -I$root/ -DNO_UNIVERSAL -DSIM_$block -D$datatype -DDIMENSION=$DIMENSION"
