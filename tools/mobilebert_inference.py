...
for batch in tqdm(eval_dataloader):
    ...
    print("PyTorch model accuracy: {:.2f}%".format(comp_correct/samples * 100))
    print("HLS model accuracy:     {:.2f}%".format(hls_correct/samples * 100))
    print("Gold model accuracy:    {:.2f}%".format(gold_correct/samples * 100))
